DROP TABLE IF EXISTS itinerary_stops, saved_itineraries, users, contact, address, poi_category, category, poi CASCADE;
...
CREATE TABLE poi (
    ...
    last_update DATE,
    poi_kind VARCHAR(20) NOT NULL DEFAULT 'attraction',
    cluster_id INTEGER
);
