...
from src.itinerary.itinerary_logic import build_itinerary, select_candidates
...
def get_user_itineraries(email: str):
    ...
    try:
        ...
        for itinerary in itineraries:
            cur.execute(
                """
                SELECT s.day_number, s.stop_order, p.label, p.poi_kind, a.street_address, a.city
